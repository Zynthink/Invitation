...
// 		// var target = new Date("May 23 2026 08:00:00 GMT+0100"); //replace with YOUR DATE
...
(function ($) {
    ...
    setInterval(function() {
        ...
        // Jika waktu sudah lewat, jangan biarkan angka jadi minus
        if (difference < 0) {
            difference = 0;
        }
    ...
    }, 1000); // Interval 1 detik sudah cukup biar tidak berat di browser
